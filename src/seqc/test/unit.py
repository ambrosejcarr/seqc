...
class FastqMergeTest(unittest.TestCase):
    ...
    @unittest.skip('slow; multiprocessing has some basic time-lag built in, and I also '
                   'added sleep() commands which exacerbate this issue for basic testing')
    def test_merge_fastq(self, data_type):
        ...
        self.assertEqual(len(name.split(':')), 6)
...
# todo merge this with below test
